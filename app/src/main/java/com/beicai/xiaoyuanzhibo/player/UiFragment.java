...
import com.beicai.xiaoyuanzhibo.Like.HeartLayout;
import com.beicai.xiaoyuanzhibo.R;
import com.beicai.xiaoyuanzhibo.bean.Gift;
import com.beicai.xiaoyuanzhibo.bean.MessageBean;
import com.beicai.xiaoyuanzhibo.customview.RoundImageView;
import com.beicai.xiaoyuanzhibo.gift.GiftPopwin;
import com.beicai.xiaoyuanzhibo.utils.DisplayUtil;
...
public class UiFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        addLike();
        userListview.setAdapter(new UserAdapter(getActivity()));//上面在线人数
    }
    ...
    private void sendText() {
        if (!etInput.getText().toString().trim().isEmpty()) {
            MessageBean messageBean = new MessageBean();
            messageBean.content = etInput.getText().toString().trim();
            messageBean.name = "小源";
            messageData.add(messageBean);
            etInput.setText("");
     ...
     * @param view
     */
    @OnClick({R.id.tvChat, R.id.like, R.id.send_gift, R.id.sendInput,R.id.close})
    ...
    public void back() {
        new android.support.v7.app.AlertDialog.Builder(getActivity()).setTitle("温馨提示").setMessage("确定结束观看？").setPositiveButton("确定", new DialogInterface.OnClickListener() {
            @Override
